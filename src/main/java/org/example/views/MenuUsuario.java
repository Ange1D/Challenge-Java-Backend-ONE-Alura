...
public class MenuUsuario extends JFrame {
    ...
    public MenuUsuario() {
        ...
        lblNewLabel_2.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/aH-150px.png"))));
        ...
        lblBusquedaDeReservas.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/pessoas.png"))));
