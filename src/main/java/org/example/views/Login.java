...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        imgHotel.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/img-hotel-login-.png"))));
        ...
        //lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/imagenes/lOGO-50PX.png"))); //NPE
        lblNewLabel_1.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/lOGO-50PX.png"))));
