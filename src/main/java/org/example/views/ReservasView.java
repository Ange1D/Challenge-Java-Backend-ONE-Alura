...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        logo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/Ha-100px.png"))));
        ...
        imagenFondo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/reservas-img-3.png"))));
        ...
        txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/icon-reservas.png"))));
