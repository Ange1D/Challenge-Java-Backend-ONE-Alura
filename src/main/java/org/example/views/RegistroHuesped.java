...
public class RegistroHuesped extends JFrame {
    ...
    public RegistroHuesped() {
        ...
        txtFechaN.getCalendarButton().setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/icon-reservas.png"))));
        ...
        imagenFondo.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenes/registro.png"))));
